...
// 工单管理相关
export const getOrders = (data) => Network.get(`/api/v1/order`, data);
export const createOrder = (data)  => Network.post(`/api/v1/order`, data);export const destroyOrder = (id) => Network.delete(`/api/v1/order/${id}`);
export const updateOrder = (id, data) => Network.put(`/api/v1/order/${id}`, data);

// 仓库管理相关
export const getStores = (data) => Network.get(`/api/v1/store`, data);
export const createStore = (data)  => Network.post(`/api/v1/store`, data);